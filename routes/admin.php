...
use App\Http\Controllers\MessageCeoController;
use App\Http\Controllers\PersentationController;
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::controller(PersonalPageset::class)->group(function () {
        Route::get('/personal_testimonials', 'testimonial')->name('personaltestimonial.index');
        Route::get('/personal_testimonials/create', 'createtestimonial')->name('personaltestimonial.create');
