...
/*ACE CONTROLLER*/
use App\Http\Controllers\ace\AceController;
use App\Http\Controllers\Payment\M1paymentController;
...
Route::controller(CartController::class)->group(function () {
    Route::get('/our_products/view/cart', 'index')->name('cart');
    Route::post('/cart/show-cart-modal', 'showCartModal')->name('cart.showCartModal');
    Route::post('/visitor/cart/getcart', 'getcart')->name('cart.getcart');
...
Route::group(['middleware' => ['user', 'verified', 'unbanned']], function() {
 ...
 Route::group(['prefix' => 'our_products'], function() {
    ...
    Route::controller(AddressController::class)->group(function () {
        Route::post('/view/cities/get-states', 'getStates')->name('get-state');
        Route::post('/view/cities/get-cities', 'getCities')->name('get-city');
...
Route::controller(M1paymentController::class)->group(function () {
    Route::any('/m1payment/status/check', 'checkunpaid')->name('m1pay.checkunpaid');
});
