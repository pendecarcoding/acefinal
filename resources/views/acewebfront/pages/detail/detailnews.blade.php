    ...
    <div data-aos="fade-up" class="aos-init aos-animate">
      <div class="col-md-12">
        <div class="banner-static">
          <img class="img-responsive-banner" src="https://aceweb.kanalapps.web.id/public/aceweb/assets/img/banner-newsrom.png" alt="">
        </div>
      </div>
    </div>
  </section>
                  ...
                  <div class="dlab-post-text isiku">
                    <div style="text-align: justify">
                      ...
                      >
                        ...
                        <div
                          onClick="parent.open('https://www.facebook.com/sharer.php?u={{ url('newsroom/'.$data->slug) }}')"
                        ...
                        <div
                        onClick="parent.open('https://twitter.com/intent/tweet?url={{ url('newsroom/'.$data->slug) }}')"
                          class="st-btn"
                        ...
                        <div
                          onClick="parent.open('https://wa.me/?text={{ url('newsroom/'.$data->slug) }}')"
                          class="st-btn"
                        ...
                        <div
                          onClick="parent.open('https://telegram.me/share/url?url={{ url('newsroom/'.$data->slug) }}&text={{ $data->title }}')"
                          class="st-btn"
                        ...
                        <div
                          onClick="parent.open('https://plus.google.com/share?url={{ url('newsroom/'.$data->slug) }}&text={{ $data->title }}')"
