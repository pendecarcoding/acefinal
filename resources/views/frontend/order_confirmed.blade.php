...
<section class="bg-banner">
   ...
   <section class="mb-4 gry-bg" style="margin-top: 150px">
                                            ...
                                            <table class="table ">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <strong><span><a onClick="printinvoice('{{$order->id}}')" style="color:white" class="btn btn-success"><i  class="fa fa-print"></i> Print </a></span></strong>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
