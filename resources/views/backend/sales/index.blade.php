                ...
                <table class="table aiz-table mb-0">
                    <thead>
                        <tr>
                            ...
                            <th style="width:150px">{{ translate('Weight & Qty') }}</th>
                    ...
                    <tbody>
                        @foreach ($orders as $key => $order)
                            <tr>
                                ...
                                <td>
                                    @foreach(showweightqty($order->id) as $i =>$vp)
                                        <span class="badge badge-inline badge-primary">{{$vp->weight}} Gram | Qty : {{$vp->quantity}} Item</span><br>
                                    @endforeach
