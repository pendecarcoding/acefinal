                    ...
                    @foreach ($data as $i => $v)
                        <tr>
                            ...
                            <td><a data-toggle="modal" data-target="#edit{{ $v->id }}"
                                    class="btn btn-soft-primary btn-icon btn-circle btn-sm"><i class="las la-edit"></i></a>
                            </td>
                        </tr>
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('margin.update') }}" method="post">{{ csrf_field() }}
                                        <div class="modal-body">
                                            ...
                                            <input id="doubleInput{{$v->id}}" oninput="validateNumberFormat(this)" value="{{ $v->margin }}" class="form-control" required
                                                name="margin">
                                        </div>
