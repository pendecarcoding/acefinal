        ...
        <div class="card">
            <div class="card-header">
                <h1 class="mb-0 h6">{{ translate('Edit Product') }}</h5>
                    ...
                    <a href="{{ route('products.discount') }}" class="btn btn-danger btn-sm"><i class="las la-times"></i></a>
            </div>
        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="hidden" placeholder="{{ translate('Unit price') }}" name="unit_price"
                            ...
                            <div class="form-group row">
                                <label
                                    class="col-lg-3 col-from-label">{{ translate('Discount   (Promotion Price / Gram)') }}</label>
                                <div class="col-lg-6">
                                    <input type="number" lang="en" min="0" step="0.01"
                                        placeholder="{{ translate('Discount') }}" name="discount" class="form-control"
                                        value="{{ $product->promo_price }}" required>
                                </div>
