    ...
    <div class="row align-items-center">
        ...
        @can('add_announcements')
            <div class="col text-right">
                <a href="{{ route('announcementsadmin.create') }}" class="btn btn-circle btn-info">
                    ...
                    <tr>
                        ...
                        <td>
                             @can('edit_announcements')
                                <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"  href="{{ route('announcementsadmin.edit',base64_encode($v->id))}}" title="{{ translate('Edit') }}">
                                    <i class="las la-pen"></i>
                                </a>
                            @endcan
                            @can('delete_announcements')
                                <a  class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('announcementsadmin.destroy', base64_encode($v->id))}}" title="{{ translate('Delete') }}">
