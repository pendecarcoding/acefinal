            ...
            <div style="display:flex;justify-content: space-between;">
                <table>
                    ...
                    <tr>
                        ...
                        <td rowspan="4">
                            <h1 style="color: @if ($order->payment_status == 'paid') green @else red @endif">
                                {{ strtoupper($order->payment_status) }}</h1>
                        </td>
                    </tr>
                    <tr>
...
?>
                            {!! str_replace(
                                $removedXML,
                                '',
                                QrCode::size(100)->generate(env('URL_WEB') . '/view/track-your-order/code?order_code=' . $order->code),
                            ) !!}
                        </td>
                        <td>
                            <table class="text-right sm-padding small strong">
