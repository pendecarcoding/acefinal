            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @canany(['add_new_product', 'show_all_products', 'show_in_house_products', 'show_seller_products',
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <!--Submenu-->
                        <ul class="aiz-side-nav-list level-2">
                            @can('setting_pricefeed')
                                <li class="aiz-side-nav-item">
                                    <a class="aiz-side-nav-link" href="{{ route('pricefeed.set') }}">
                                        <span class="aiz-side-nav-text">{{ translate('Price Override') }}</span>
                                    </a>
                                </li>
                            @endcan
                            @can('setting_margin')
                            ...
                            @can('in_house_product_sale_report')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('in_house_sale_report.index') }}"
                                        ...
                                        <span class="aiz-side-nav-text">{{ translate('ACE Product Sale') }}</span>
                                    </a>
                                </li>
                            @endcan
                ...
                @canany(['view_blogs', 'view_blog_categories'])
                    <li class="aiz-side-nav-item">
                        ...
                        <a href="#" class="aiz-side-nav-link {{ areActiveRoutes(['blog.create', 'blog.edit']) }}">
                            ...
                            @can('view_about')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('about.index') }}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['about.create', 'about.edit']) }}">
                            ...
                            @can('view_testimonial')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('testimonial.index') }}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['testimonial.create', 'testimonial.edit']) }}">
                            ...
                            @can('view_patners')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('patners.index') }}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['patners.create', 'patners.edit']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Patners') }}</span>
                                    </a>
                                </li>
                            @endcan
                            @can('view_requestpatner')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('requestpatner.index') }}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['requestpatner.create', 'requestpatner.edit']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Request Patner') }}</span>
                                    </a>
                                </li>
                            @endcan
                            @can('view_providers')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('providers.index') }}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['providers.create', 'providers.edit']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Providers') }}</span>
                                    </a>
                                </li>
                            @endcan
                            <!-- @can('view_blogs')
                ...
                @canany(['view_personal', 'view_personalpageset', 'view_personaltestimonial'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{ translate('Personal Page') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                ...
                <!--Investor RElation-->
                <!--Blog System-->
                @canany(['view_investor', 'view_messagefromceo'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <i class="las la-coins aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{ translate('Investor Relations') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            @can('view_bannerinvestor')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('investor.bannerset') }}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['investor.bannerset']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Set Banner Investor') }}</span>
                                    </a>
                                </li>
                            @endcan
                            @can('view_messageceo')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('messagefromceo.index') }}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['messagefromceo.create', 'messagefromceo.edit']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Message From CEO') }}</span>
                                    </a>
                                </li>
                            @endcan
                            ...
                            @can('view_announcements')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('announcements.index') }}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['announcements.create', 'announcements.edit']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Announcements') }}</span>
                                    </a>
                                </li>
                            @endcan
                            ...
                            @can('view_downloads')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('downloads.index') }}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['downloads.create', 'downloads.edit']) }}">
                            ...
                            @can('view_ir_persentation')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('persentation.index') }}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['persentation.create', 'persentation.edit']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('IR Persentation') }}</span>
                                    </a>
                                </li>
                            @endcan
                        ...
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                @can('view_all_copstaff')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('copstaff.index') }}"
                                            class="aiz-side-nav-link {{ areActiveRoutes(['copstaff.index', 'copstaff.create', 'copstaff.edit']) }}">
