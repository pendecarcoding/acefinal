...
class OrderController extends Controller
{
    ...
    {
        $carts = Cart::where('temp_user_id', session()->get('temp_user_id'))
            ->get();
        ...
        $address = Address::where('temp_id', $carts[0]['temp_user_id'])->first();
        ...
        $combined_order->temp_user_id = session()->get('temp_user_id');
